...
divYorubaParagrafos = document.getElementsByClassName("left odu-transcription rounded-small")[0].children
linksPagina = document.getElementsByTagName("a")
...
function pegaConteudoYoruba(){

  for (i = 0; i < divYorubaParagrafos.length; i++) {
  yorubaText += divYorubaParagrafos[i].innerText + "/n";
